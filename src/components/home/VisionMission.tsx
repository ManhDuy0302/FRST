        ...
        <section className="py-16 md:py-20 lg:py-24 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                    {/* Vision */}
                    <div className="group bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 md:p-10 hover:shadow-xl transition-all duration-500 animate-fade-in-left">
                    ...
                    {/* Mission */}
                    <div className="group bg-gradient-to-br from-navy-900 to-navy-800 rounded-2xl p-8 md:p-10 hover:shadow-xl transition-all duration-500 animate-fade-in-right delay-200">
                        <div className="flex items-center mb-6">
